        ...
        {"data": "IsActive"},
        {
            ...
            "render": function(data, type, full) {
                var edit =  '<td>';
                    ...
                    edit +=' <a href="'+ url +' delete" data-id ="' + full.JurusanId + '" data-name ="' + full.user_full_name + '" class="btn btn-danger btn-circle delete-confirm" rel="tooltip" title="Delete Jurusan" data-placement="top" ><i class="fa fa-trash-o"></i></a>';
                    edit +=  '</td>';
